...
async def register_user(
    ...
    try:
        ...
        activation_link = f"http://127.0.0.1:8000/accounts/activate?token={activation_token.token}"
...
async def activate_account(
    ...
    # Sending an email about successful activation
...
async def request_password_reset_token(
    ...
    reset_link = f"http://127.0.0.1:8000/accounts/reset-password?token={reset_token.token}"
    background_tasks.add_task(
...
async def reset_password(
    ...
    try:
        ...
        # Sending a letter about successful password reset
        login_link = "http://127.0.0.1:8000/accounts/login/"
        background_tasks.add_task(
